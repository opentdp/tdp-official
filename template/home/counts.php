                    ...
                    <div class="row">
                        <div class="col-md-6 d-md-flex align-items-md-stretch">
                            <div class="count-box">
                                ...
                                <p><strong>项目经验</strong> 人均10年以上</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 d-md-flex align-items-md-stretch">
                            <div class="count-box">
                                ...
                                <span data-purecounter-start="0" data-purecounter-end="4272" data-purecounter-duration="1" class="purecounter"></span>
                                <p><strong>终端数量</strong> 累计安装数量</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 d-md-flex align-items-md-stretch">
                            <div class="count-box">
                                ...
                                <p><strong>发布版本</strong> 累计发布版本数量</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 d-md-flex align-items-md-stretch">
                            <div class="count-box">
                                ...
                                <p><strong>关注数量</strong> Github 关注总数</p>
                            </div>
                        </div>
                    </div>
                </div>
