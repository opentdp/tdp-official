<header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                <li><a class="nav-link scrollto active" href="index.php?mod=home#hero">首页</a></li>
                <li><a class="nav-link scrollto" href="index.php?mod=home#about">关于</a></li>
                <li class="dropdown">
                ...
                <li><a class="nav-link scrollto" href="index.php?mod=home#services">动态</a></li>
                <li><a class="nav-link scrollto" href="index.php?mod=home#features">推荐</a></li>
                <li><a class="nav-link scrollto" href="index.php?mod=home#team">团队</a></li>
                <li><a class="nav-link scrollto" href="index.php?mod=home#contact">联系</a></li>
                <li><a class="nav-link" href="https://docs.opentdp.org" target="_blank">文档</a></li>
                <li><a class="getstarted scrollto d-none d-lg-inline" href="index.php?mod=home#about">启航</a></li>
            </ul>
